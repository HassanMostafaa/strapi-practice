...
export type IGenF_Search_ResultsFragment = { __typename?: 'ComponentMoleculesSearchResults', id: string, emptyStateText: string | null, initialStateText: string | null, searchInput: { __typename?: 'ComponentAtomsGenericInput', id: string, placeholderText: string | null, defaultValue: string | null, startIcon: { __typename?: 'UploadFile', url: string, name: string, mime: string, alternativeText: string | null } | null, endIcon: { __typename?: 'UploadFile', url: string, name: string, mime: string, alternativeText: string | null } | null } | null };
